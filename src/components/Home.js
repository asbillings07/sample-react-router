...
export default class Home extends Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    // accessing the input value from the ref
...
// ref attribute takes a callback function that recieves the underlying the dom element. As soon as it mounts to the dom we can access this.name and this.topic
